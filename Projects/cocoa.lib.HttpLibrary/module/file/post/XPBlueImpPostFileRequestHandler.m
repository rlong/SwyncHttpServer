...
#import "XPBlueImpPostFileRequestHandler.h"
...
@interface XPBlueImpPostFileRequestHandler ()
...
@implementation XPBlueImpPostFileRequestHandler
...
-(JBHttpResponse*)buildResponse:(XPPostFileMultiPartHandler*)fileUploadMultiPartHandler {
    ...
    id<JBEntity> entity;
    {
        ...
        
        {
            ...
            if( nil != fileUploadMultiPartHandler ) {
                ...
                for( XPPostFilePartHandler* fileUploadPartHandler in fileUploadPartHandlers ) {
...
-(id)initWithStorageManager:(id<XPStorageManager>)storageManager  {
    ...
    XPBlueImpPostFileRequestHandler* answer = [super init];
