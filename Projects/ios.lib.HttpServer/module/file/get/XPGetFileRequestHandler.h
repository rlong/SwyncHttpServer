...
@interface XPGetFileRequestHandler : NSObject <JBRequestHandler> {
...
//@property (nonatomic, retain) XPMediaHandleSet* mediaHandles;
////@synthesize mediaHandles = _mediaHandles;
//
//
//// getFileListener
////id<AVGetFileListener> _getFileListener;
//@property (nonatomic, retain) id<XPGetFileListener> getFileListener;
