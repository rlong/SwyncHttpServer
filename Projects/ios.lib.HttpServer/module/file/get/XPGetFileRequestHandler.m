...
@interface XPGetFileRequestHandler ()
...
@implementation XPGetFileRequestHandler
...
//        
//        XPGetFileEntityWrapper* entityWrapper = [[XPGetFileEntityWrapper alloc] initWithDelegate:entity getFileListener:_getFileListener];
...
-(id)initWithRequestHandlerUrl:(NSString*)requestHandlerUrl {
    ...
    XPGetFileRequestHandler* answer = [super init];
    
    if( nil != answer ) {
        
//        answer->_mediaHandles = [[XPMediaHandleSet alloc] init];
